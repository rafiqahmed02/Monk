...
import EventDetails from "../../../v1/components/MobileViewComponents/EventComponent/EventDetails/EventDetails";
...
vi.mock("../../../v1/redux/actions/EventActions/FetchingEventRsvp", () => ({
  FetchRSVPByEventId: vi.fn(),
}));
...
vi.mock(
  ...
  () => ({
    __esModule: true,
    default: () => <div data-testid="event-carousel">Event Carousel</div>,
  })
);
...
vi.mock(
  "../../../../components/MobileViewComponents/EventComponent/EventDetails/EventDetails",
  () => ({
    __esModule: true,
    default: () => (
      <div data-testid="event-details-component">EventDetailsComponent</div>
    ),
  })
);
...
describe("EventDetails Component", () => {
  ...
  beforeEach(() => {
    ...
    (useCancelEvent as unknown as vi.Mock).mockReturnValue({
    ...
    (useGetEvent as unknown as vi.Mock).mockReturnValue({
      event: mockEventData,
      loading: false,
      error: null,
      refetch: mockRefetch,
    });
    (FetchRSVPByEventId as unknown as vi.Mock).mockReturnValue(mockFetchRSVP);
